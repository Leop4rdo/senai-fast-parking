...
INSERT INTO `customer` VALUES (1,'John Doe','johndoe@gmail.com','11963677923','senha123'),(2,'Abraham Lincoln','abrahamlikesapple@gmail.com','53408398237','passwordonetwothree'),(3,'Leo Cemia','email@gmail.com','11999999999','pkpkpkpk'),(4,'Sr. Banana','bananananica@gmail.com','11979797979','bananaprata');
...
INSERT INTO `parking_spot` VALUES (1,'A-1',1),(2,'B-100',2),(3,'A-3',2),(4,'A-4',1),(5,'A-5',3),(6,'A-6',3),(7,'A-7',5),(8,'A-8',1),(9,'A-9',4),(10,'A-10',1),(11,'B-1',1),(12,'B-2',1),(13,'B-3',5),(14,'B-4',1),(15,'B-5',3),(16,'B-6',1),(17,'B-7',2),(18,'B-8',1),(19,'B-9',4),(20,'B-10',1);
...
INSERT INTO `vehicle` VALUES (1,'JJJJ-888',2,3,5,4),(2,'AAAA-321',4,3,4,1),(3,'BBBB-321',5,5,8,1),(4,'CCCC-321',7,1,3,1),(7,'GGGG-999',1,1,1,1),(8,'IIII-888',2,3,5,4);
...
INSERT INTO `vehicle_colour` VALUES (6,'Amarelo'),(5,'Azul'),(13,'Bege'),(3,'Branco'),(15,'Bronze'),(2,'Cinza'),(17,'Creme'),(16,'Dourado'),(18,'Laranja'),(20,'Lilás'),(11,'Marrom'),(12,'Prata'),(1,'Preto'),(9,'Rosa'),(8,'Roxo'),(7,'Verde'),(4,'Vermelho'),(19,'Vinho'),(14,'Violeta');
...
INSERT INTO `vehicle_model` VALUES (1,'Conversível.'),(2,'Sedã'),(3,'SUV'),(4,'Minivan'),(5,'Honda CG 160'),(6,'Trail'),(7,'Jato'),(8,'Turboélice'),(9,'SW.'),(11,'Hatchback.');
...
INSERT INTO `vehicle_type` VALUES (1,'Carro',10),(2,'Moto',17),(3,'Van',15),(4,'Ônibus',20),(5,'Avião',50);
...
-- Dump completed on 2022-06-01 16:51:47
