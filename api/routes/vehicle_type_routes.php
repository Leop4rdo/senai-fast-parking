...
$app->get("/v1/vehicle-types/{id}",  function (Request $request, Response $response, array $args) {
    $controller = new VehicleTypeController();
...
$app->patch("/v1/vehicle-types/{id}", function (Request $request, Response $response, array $args) {
    $controller = new VehicleTypeController();
